...
**Research**: My research interests lie in automatic construction of high-performance libraries for heterogeneous hardware. This work includes the [Sparse Workspace](https://dl.acm.org/doi/10.1145/3656426) and [Sgap](https://arxiv.org/pdf/2209.02882) compilers for sparse tensor algebra on CPU and GPU, respectively; [ASPL Agent](https://zhang677.github.io/blog_md/aspl.html) and [AccelOpt](https://ppl.stanford.edu/accelopt.html) self-improving agents for ML kernels on AI accelerators. I also hand-optimized GPU kernels before. This work includes inference kernels for [TTT-KVB](https://arxiv.org/pdf/2407.04620) and [CATS](https://scalingintelligence.stanford.edu/blogs/cats/).
