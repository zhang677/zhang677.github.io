...
**Research**: My research interests lie in better programming models and systems for domain-specific architectures. This work includes the [Sparse Workspace](https://dl.acm.org/doi/10.1145/3656426) for sparse tensor algebra and the [AccelOpt](https://ppl.stanford.edu/accelopt.html) self-improving agents. I am also interested in optimizing GPU kernels for emerging applications, including sparse and recurrent neural networks.
