...
<div class="figure" style="text-align: center;">
  ...
  <div class="caption">
    <strong>Figure 8</strong> <i>Magic of Optimization Memory</i> generated by Nano Banana Pro.
  </div>
</div>
<br>
...
<div class="figure">
  ...
  <div class="caption">
    <strong>Figure 9</strong> Performance evaluation of AccelOpt on selected FlashInfer-Bench problems. The y-axis represents latency, where a lower score signifies better kernels.
  </div>
</div>
<br>
...
<div class="figure" style="text-align: center;">
  ...
  <div class="caption">
    <strong>Figure 10</strong> Speedup comparison between AccelOpt and AccelOpt + Iterative refinement (Fixer).
  </div>
</div>
<br>
...
<div class="figure" style="text-align: center;">
  ...
  <div class="caption">
    <strong>Figure 11</strong> Cost comparison between AccelOpt and AccelOpt + Iterative refinement (Fixer).
  </div>
</div>
<br>
...
<div class="figure" style="text-align: center;">
  ...
  <div class="caption">
    <strong>Figure 12</strong> Performance comparison between AccelOpt with Fixer and FlashInfer.
  </div>
</div>
<br>
