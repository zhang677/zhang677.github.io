...
In scientific discovery, the progress is also bounded by how humans interpret the data and decide the next step. If the agents can digest data and make reasonable plans with the same quality as humans but much faster, then scientifc discovery will be much faster at the experience accumulation stage. However, it is still unknown whether more experiences could lead to paradigm shifts.